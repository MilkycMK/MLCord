 ...
 */
    ...
    /*
     allows your app to update a user's activity - requires Discord approval (NOT REQUIRED FOR GAME_SDK ACTIVITY MANAGER)
     */
    ACTIVITIES_WRITE,
    ...
    public static OAuthScope getByName(String name) {
    ...
    public static List<OAuthScope> getByName(List<String> names) {
        List<OAuthScope> scopes = new ArrayList<>();
        for (String name : names) {
            OAuthScope scope = getByName(name);
            if (scope != null) {
                scopes.add(scope);
            }
        }
